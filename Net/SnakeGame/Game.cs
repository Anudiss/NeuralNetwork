...
namespace Net.SnakeGame
{
    public class Game
    {
        ...
        {
            Snake.Net.PerceptionLayer[0].Output = Snake.Head.X;
            Snake.Net.PerceptionLayer[1].Output = Snake.Head.Y;
            Snake.Net.PerceptionLayer[2].Output = Apple.X;
            Snake.Net.PerceptionLayer[3].Output = Apple.Y;
